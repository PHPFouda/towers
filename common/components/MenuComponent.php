...
/**
 * Class MenuComponent
 * Theme MenuComponent widget.
 */
class MenuComponent extends \yii\widgets\Menu
{
    /**
     * @inheritdoc
     */
    ...
    {
        if(isset($item['items'])) {
            $pull = (Yii::$app->language=='en')?'pull-right':'pull-left';

            $labelTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container"><i class="fa fa-angle-left '.$pull.'"></i></span></a>';
            $linkTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container"><i class="fa fa-angle-left '.$pull.'"></i></span></a>';
        }
        else {
